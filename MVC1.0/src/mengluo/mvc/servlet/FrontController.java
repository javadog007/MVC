...
import mengluo.mvc.action.Action;
import mengluo.mvc.action.ActionResult;
import mengluo.mvc.action.ResultContent;
import mengluo.mvc.action.ResultType;
import mengluo.mvc.upload.Uploadable;
import mengluo.mvc.util.CommonUtil;
import mengluo.mvc.util.ReflectionUtil;

@WebServlet(urlPatterns = {"*.do"},loadOnStartup = 0,
		initParams = {
			@WebInitParam(name = "packagePrefix" , value = "mengluo.mvc.action."),
